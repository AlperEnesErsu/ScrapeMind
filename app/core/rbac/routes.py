...
def role_delete(role_id: int):
    ...
    log_action("role.delete", entity_type="role", entity_id=role.id, changes={"name": role.name})
...
def permission_list():
    return render_template("rbac/permission_list.html", grouped_perms=list_permissions_by_module())
