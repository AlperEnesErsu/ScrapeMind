...
lazy_gettext("ScrapeMind monitors academic papers matching your specific keywords. Follow these steps to set up your personalized research feed:")
...
lazy_gettext('Once interests are added, click the "Scrape Now" button to search and import papers from arXiv.')
lazy_gettext("Read and Analyze")
lazy_gettext("Papers will populate your homepage. Use ScrapeMind's AI features to instantly translate abstracts or write notes.")
...
lazy_gettext("Scraping queries ArXiv and other databases using your research interest keywords to find matching papers.")
