...
def test_agent_reach_sources_registered():
    ...
    assert AVAILABLE_SOURCES["youtube_reach"] == agent_reach_source
    assert AVAILABLE_SOURCES["github_reach"] == agent_reach_source
    assert AVAILABLE_SOURCES["web_reach"] == agent_reach_source
